                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 min-w-0">
                          <select
                            ...
                            className="w-full sm:w-24 shrink-0 px-2 py-3 bg-gray-50 border-0 rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all outline-none text-sm"
                          >
                          ...
                          <input
                            ...
                            className="w-full sm:flex-1 min-w-0 px-4 py-3 bg-gray-50 border-0 rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all outline-none"
